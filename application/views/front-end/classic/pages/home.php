...
$custom_steps = [
    [
        'en' => 'Create a username and password',
        'es' => 'Cree su usuario y contraseña',
        'image' => base_url('/uploads/media/2021/step-1.png')
    ],
    [
        'en' => 'Select your products',
        'es' => '.Seleccione sus productos',
        'image' => base_url('/uploads/media/2021/step-2.png')
    ],
    [
        'en' => 'Place your order',
        'es' => 'Realice su pedido',
        'image' => base_url('/uploads/media/2021/step-3.png')
    ],
    [
        'en' => 'Make your payment',
        'es' => 'Realice su pago',
        'image' => base_url('/uploads/media/2021/step-4.png')
    ],
    [
        'en' => 'Receive your products',
        'es' => 'Reciba sus productos',
        'image' => base_url('/uploads/media/2021/step-5.png')
    ],
];
?>
                                ...
                                <div class="icon-box-wrapper">
                                    <div class="info-box-icon">
                                        <div class="svg-wrapper">
                                            <img src="<?= $step['image'] ?>" style="height: 40pt; width: 40pt;" alt="Image not available" />
                                        </div>
                                    </div>
                                </div>
