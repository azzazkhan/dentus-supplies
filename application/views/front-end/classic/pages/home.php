...
if ($this->lang->is_loaded["web_labels_lang.php"] == "spanish"):
        echo "Aplicación móvil Dentus Supplies";
    else:
        echo "Dentus Supplies Mobile App";
    endif;
    ?>
                            </p>
                            <p>
...
if ($this->lang->is_loaded["web_labels_lang.php"] == "spanish"):
    ...
    ?>
                        ...
                        <p class="header-p">
                            <?php
if ($this->lang->is_loaded["web_labels_lang.php"] == "spanish"):
        echo "Compre con nosotros a precios asequibles y obtenga descuentos y ofertas interesantes.";
    else:
        echo "Shop with us at affordable prices and get exciting cashback and offers.";
    endif;
    ?>
                        </p>
