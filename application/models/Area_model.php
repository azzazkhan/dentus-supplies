...
class Area_model extends CI_Model
{
    ...
    function get_area_by_city($city_id, $limit = 25, $offset = 0, $sort = "a.name", $order = "ASC", $search = "")
    {
        $multipleWhere = '';
        $where = array();
        if (!empty($search)) {
    ...
    function get_cities( $sort = "c.name", $order = "ASC", $search = "")
    {
        $multipleWhere = '';
        $where = array();
        if (!empty($search)) {
        ...
        $cities = $search_res->group_by('c.id')->order_by($sort, $order)->get('cities c')->result_array();
        $bulkData = array();
