    ...
    <div class="main-content responsive-breadcrumb">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?= !empty($this->lang->line('details')) ? $this->lang->line('details') : 'Details' ?></li>
            </ol>
        </nav>
    </div>
...
<section class="content main-content product-page-content my-3 py-3">
    <div class="row mx-0">
        ...
        <div class="col-12 col-md-6 product-page-details">
            ...
            <p><?= $product['product'][0]['short_description'] ?></p>
            <hr>
