    ...
    <div class="main-content">
        <div class="mt-5 mb-3 col-md-12">
            <div class="user-detail align-items-center">
                <div class="ml-3">
                    <h6 class="mb-0 text-muted"><?= !empty($this->lang->line('hello')) ? $this->lang->line('hello') : 'Hello' ?></h6>
                            ...
                            if (isset($products) && !empty($products)) {
                                ...
                                <div class="m-5 col-12">
                                    <div class="text-center">
                                        ...
                                        <a href="<?= base_url('products') ?>" class="button button-rounded button-warning" style="background-color: #159BFF !important; border: 0">Go to Shop</a>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
