...
*/
    ...
    public function __construct()
    {
        ...
        $this->load->model(['category_model', 'order_model', 'rating_model', 'cart_model', 'Area_model', 'address_model', 'transaction_model', 'ticket_model', 'Order_model', 'notification_model', 'faq_model']);
    ...
    public function get_areas_by_city_id()
    {
       ...
       */
        ...
        if (!$this->form_validation->run()) {
            ...
            $result = $this->Area_model->get_area_by_city($id, $limit, $offset, $sort, $order, $search);
    ...
    */
            ...
            if (!empty($res)) {
                ...
                for ($i = 0; $i < count($res); $i++) {
                    ...
                    if (!empty($pro_details)) {
                        $res[$i]['product_details'] = $pro_details['product'];
                    }
                }
            } else {
                $this->response['error'] = true;
    ...
    public function get_sections()
    {
        ...
        if (!empty($sections)) {
            ...
            // $this->response['error'] = false;
            // $this->response['message'] = "Sections retrived successfully";
            // $this->response['total'] = $products['total'];
    ...
    public function flutterwave_webview()
    {
        /* 
            amount:100
            user_id:73
            reference:DentusSupplies-165232013-400  // { optional }
        */
        if (!$this->verify_token()) {
            return false;
        }
